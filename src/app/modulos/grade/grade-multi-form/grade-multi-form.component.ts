...
export class GradeMultiFormComponent implements OnInit {
  ...
  onSubmit(){
    if(this.gradeForm.valid){
       ...
       this.gradeService.saveGradeMultipla(this.gradeForm.value).subscribe(
          success => {this.globalService.saveShow("Gerado com Sucesso!", "Grade em demanda.") }
        )
    }
